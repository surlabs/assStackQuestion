...
*/
	...
	public function getOptionsPart(stack_options $options, string $general_feedback)
	{
		...
		if ($this->new_question) {
			...
			$options_assume_real->setChecked((int)$this->default["options_assume_real"]);
			...
			$options_assume_real->setChecked((int)$options->get_option('assumereal'));
	...
	public function getInputPart(stack_input $input)
	{
		...
		if ($this->new_question) {
            ...
            $input_syntax_attribute->setValue($this->default["input_syntax_attribute"]);
            ...
            $input_syntax_attribute->setValue($input->get_parameter('syntaxAttribute'));
