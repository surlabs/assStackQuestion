...
class stack_cas_configuration {
    ...
    public function __construct() {
		...
		// fim: get path to maxima
		$this->maximacodepath =  str_replace(chr(92),"/",realpath(dirname(__FILE__).'/../maxima'));
...
END;
    ...
    public static function images_location() {
        global $CFG;
		// fim: path to images location
		return $CFG->dataroot . '/stack/plots';
		// fim.
    }
    ...
    public static function create_maximalocal() {
		// fim: creation of images directories
