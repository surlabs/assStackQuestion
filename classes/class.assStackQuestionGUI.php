			...
			if (preg_match("[[feedback:" . $prt_name . "]]", $specific_feedback))
			{
				if (isset($solutions["prt"][$prt_name]))
				{
					if (strlen($solutions["prt"][$prt_name]["errors"]) OR strlen($solutions["prt"][$prt_name]["feedback"]))
					{
						...
						$specific_feedback_text = "<p>" . $solutions["prt"][$prt_name]["errors"] . "</p><p>" . $solutions["prt"][$prt_name]["feedback"] . "</p>";
						$specific_feedback = str_replace("[[feedback:" . $prt_name . "]]", $specific_feedback_text, $specific_feedback);
						//Decorate specific feedback
						$specific_feedback = '<div class="alert alert-warning" role="alert">' . $specific_feedback;
						$specific_feedback .= '</div>';
					} else
					{
						$specific_feedback = "";
					}
