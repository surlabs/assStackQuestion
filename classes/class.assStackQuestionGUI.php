    ...
    private function generateSpecificPostData() :void
    {
        ...
        foreach ($this->object->prts as $prt_name => $prt) {
            ...
            foreach ($this->object->prts[$prt_name]->get_nodes() as $name => $node) {
                ...
                $this->specific_post_data[$prefix . '_teacher_answer'] = ((isset($_POST[$prefix . '_teacher_answer']) and $_POST[$prefix . '_teacher_answer'] != null) ? assStackQuestionUtils::_debugText($_POST[$prefix . '_teacher_answer']) : '');                $this->specific_post_data[$prefix . '_options'] = ((isset($_POST[$prefix . '_options']) and $_POST[$prefix . '_options'] != null) ? trim(ilUtil::secureString($_POST[$prefix . '_options'])) : '');
