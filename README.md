...
- **This STACK for ILIAS plugin version requires a Maxima Server with the maxima version 2023121100. Other versions may trigger validation errors or not show the question at all**
